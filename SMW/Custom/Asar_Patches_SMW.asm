; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SMW_InsertIntegratedPatches and SMW_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SMW_ApplyPatchesPostAssembly()
